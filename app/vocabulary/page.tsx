    ...
    <AppShell title="Kelimelerim">
      <div className="mb-4 grid grid-cols-2 gap-2">
        <Link
          ...
          className="rounded-xl border border-brand bg-brand-light px-3 py-3 text-center text-sm font-semibold text-brand-dark"
        >
          ＋ Kelime paketleri
        </Link>
        <Link
          href="/verbs"
          className="rounded-xl border border-slate-300 bg-white px-3 py-3 text-center text-sm font-semibold text-slate-700"
        >
          📖 Düzensiz fiiller
        </Link>
      </div>
